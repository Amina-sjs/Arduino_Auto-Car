...
* **Communication Module:** **Bluetooth Module (HC-05/HC-06)**
    * *Role:* Enables **wireless control** of the robot via a smartphone or other device.
* **Proximity/Line Sensor:** **IR Sensors (Infrared Sensors)**
    * *Role:* Used to detect the **edge of a surface** (fall prevention) or for **line-following** navigation.
